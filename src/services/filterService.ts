...
const DEFAULT_FILTERS: AstroFilter[] = [
  ...
  },
  {
    ...
    moonCompatible: true,
    color: '#7C4DFF',
    description: 'Filtre dual-3nm Hα (656.3nm) + OIII (496/500.7nm). Blocking >OD4 (300-1000nm). Pas adapté aux faisceaux rapides (f<4).',
  ...
  },
  {
    ...
    moonCompatible: false,
    color: '#FF9800',
    description: 'Filtre anti-pollution lumineuse IDAS. 3 bandes passantes: bleu (428nm/28nm, 89%), vert (525nm/69nm, 97.5%), rouge (675nm/51nm, 97.5%). Blocking <1% entre bandes. Passe H\u03b2, [OIII], continu galactique, NII, H\u03b1.',
